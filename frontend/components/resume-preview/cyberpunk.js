          ...
          <div className="relative bg-black border border-cyan-500/50 rounded-lg p-8">
            <div className="flex justify-between items-start">
              <div>
                ...
                {data.title.birth && <span className="text-teal-100">{new Date().getFullYear() - new Date(data.title.birth).getFullYear()} y.o.</span>}
            ...
            <div className="border border-cyan-500/50 rounded-lg p-4 bg-cyan-950/20">
              ...
              <div className="space-y-2 text-xs font-mono">
                ...
                {data.contact?.address && (
                  ...
                  >{" "}
                    <Pin className="w-4 h-4 text-purple-600 dark:text-purple-400 shrink-0 mt-1" />{" "}
                    <div className="text-gray-50 dark:text-gray-50">
