            ...
            <CardContent className="p-8">
              <div className="flex flex-col items-center text-center gap-6">
                ...
                <div>
                  ...
                  {data.title.birth && <span className="text-gray-500">{new Date().getFullYear() - new Date(data.title.birth).getFullYear()} y.o.</span>}
                </div>
                ...
                <div className="flex flex-col w-full gap-3">
                  ...
                  {data.contact?.address && (
                    <div
                      className="flex items-start gap-3 text-sm p-2 rounded-lg text-gray-700 dark:text-gray-300 justify-start"
                    >
                      <Pin className="w-4 h-4 text-blue-600 dark:text-blue-400 shrink-0 mt-1" />
